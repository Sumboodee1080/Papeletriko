<h5>Gumawa ng Punan Sa Blangkong Aktibidad</h5>
<hr>
<form id="fillInTheBlankForm" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-md-6">
            <h6>Mga Detalye ng Aktibidads</h6>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <p><strong>Tandaan:</strong>Magpasok ng Textbox sa pamamagitan ng paggamit ng _ na simbolo. Para sa Halimbawa:<br>Ang isang _ kayumanggi _ ay tumalon sa ibabaw ng _ tamad na aso.<br>Ang _ simbolo ay ire-render bilang textbox sa view ng mag-aaral.</p>
            </div>
...
<script>
    var fillInTheBlankForm = $("#fillInTheBlankForm");

    fillInTheBlankForm.on("submit", function(event) {

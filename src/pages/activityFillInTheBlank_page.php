<h5>Create Fill In The Blank Activity</h5>
<hr>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <p><strong>Note:</strong>Insert a Textbox by using the _ symbol. For Example:<br>A _ brown _ jumps over _ lazy dog.<br>The _ symbol will render as textbox on student view.</p>
            </div>

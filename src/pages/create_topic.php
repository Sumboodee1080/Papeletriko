<div>
    <div>
        <h5>Pamamahala ng Paksa</h5>
    </div>
    <div style="margin-top: 20px;">
        <select id="module" class="form-select">
            <option selected disabled>Piliin ang Module</option>
            <?php
        ...
        <div class="row">
            <div class="col-md-6">
                <form id="topicDetailsForm" method="post" enctype="multipart/form-data">
                    ...
                    <p><strong>Tandaan:</strong> Upang magdagdag ng larawan sa pagitan ng teksto. Halimbawa, sumusulat ka para sa isang nilalaman tungkol sa hayop; <br>Ito ay isang Koala [[koala_image_480.png]]<br>Dapat na tumutugma ang filename sa magagamit na pag-upload ng file.<br>Upang magdagdag ng link, balutin ang iyong link ng [www.yourlinkHere.com]</p>
                    <div class="mb-3">
                        <label for="topicImgAttachment" class="form-label">Nilalaman ng Larawan</label>
            ...
            <!-- Topic List -->
            <div class="col-md-6">
                <h6>Umiiral na Listahan ng Paksa</h6>

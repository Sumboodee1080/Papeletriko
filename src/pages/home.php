    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <?php if (hasPrivilege('modules')) : ?>
          <li class="nav-item">
            <a class="nav-link <?php if (isset($_GET['page']) && $_GET['page'] === 'modules') echo 'active'; ?>" href="?page=modules">Mga Aralin</a>
          </li>
        <?php endif; ?>

        <?php if (hasPrivilege('profile')) : ?>
          <li class="nav-item">
            <a class="nav-link <?php if (isset($_GET['page']) && $_GET['page'] === 'profile') echo 'active'; ?>" href="?page=profile">Propayl</a>
          </li>
        <?php endif; ?>

        <?php if (hasPrivilege('management')) : ?>
          <li class="nav-item">
            <a class="nav-link <?php if (isset($_GET['page']) && $_GET['page'] === 'management') echo 'active'; ?>" href="?page=management">Patnugutan</a>
          </li>
        <?php endif; ?>
        ...
        <li class="nav-item">
          <a href="?logout=true" class="btn btn-primary logout-btn">Lumabas<i class="bi bi-box-arrow-right"></i></a>
        </li>
      </ul>
    </div>

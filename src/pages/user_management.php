    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form id="userDetailsForm" method="post">
                <div class="mb-3">
                    <label for="firstName" class="form-label">Unang Pangalan</label>
                    <input type="text" class="form-control" id="firstName" name="firstName" required>
                </div>
                <div class="mb-3">
                    <label for="middleName" class="form-label">Gitnang Pangalan</label>
                    <input type="text" class="form-control" id="middleName" name="middleName">
                </div>
                <div class="mb-3">
                    <label for="lastName" class="form-label">Apelyido</label>
                ...
                <button type="submit" id="submitBtn" class="btn btn-primary">Magrehistro / Mag-update</button>
            </form>
        </div>

        <!-- User List -->
        <div class="col-md-6 userList">
            <h2>Listahan ng Gumagamit</h2>

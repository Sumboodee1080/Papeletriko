...
$query = "SELECT a.ID, a.PROPERTY_1 AS ActivityName, a.ACTIVITY_TYPE, a.END_DTTM, s.ID AS SubmissionID
          ...
          WHERE a.MODULE_HEADER = :moduleId AND NOW() BETWEEN a.START_DTTM AND a.END_DTTM AND a.ACTIVE_SW = 1";
$stmt = $dbConn->prepare($query);
$stmt->bindParam(':moduleId', $moduleId, PDO::PARAM_INT);
...
<div>
    ...
    ?>
            <div class="mb-3">
                <div class="card" style="padding: 15px;">
                    ...
                    <label>Activity Type: <?php echo $activity['ACTIVITY_TYPE']; ?></label>
                    ...
                    <div class="mt-4">
                        ...
                        ?>
                        <a href="?page=<?php echo $page; ?>&activityId=<?php echo $activity['ID']; ?>" class="btn btn-primary">Take Activity <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        <?php } ?>
    ...
    <?php if (!$unsubmittedActivities) { ?>
        <div style="text-align: center;">
            <p>No Unsubmitted Activities to Display</p>
        </div>
    <?php } ?>
</div>